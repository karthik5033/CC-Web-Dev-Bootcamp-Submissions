...
- [x] `task1.js` — basic promise resolve/reject
- [x] `task2.js` — 3 chained `.then()` blocks
...
Name   :VANAJA S R
USN    :1RZ25CS197
GitHub :https://github.com/vanajasr
```

---

_Assignments by [@karthik5033](https://github.com/karthik5033) & [@A5CENSION-SRT](https://github.com/A5CENSION-SRT) · CC Web Dev Bootcamp_
